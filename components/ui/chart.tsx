    ...
    return (
      ...
      >
        ...
        <div className="flex items-center gap-2">
            ...
            <div
              className={cn(
                "shrink-0 rounded-[2px] border-[--color] bg-[--color]",
                {
                  ...
                  "h-0.5 w-3 border-2 border-dashed bg-transparent":
                    indicator === "dashed",
                }
              )}
              style={
          ...
          <span
            className={cn(
              "flex flex-1 justify-between leading-none text-muted-foreground",
              hideIndicator && "justify-end"
            )}
          >
            <span className="tabular-nums text-foreground">
              {formatter
                ? (formatter(tooltipPayload.value, tooltipPayload.name) as React.ReactNode)
                : String(tooltipPayload.value)}
            </span>
          </span>
        </div>
      </div>
